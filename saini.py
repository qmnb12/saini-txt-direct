...
async def download_video(url,cmd, name):
    download_cmd = f'{cmd} --no-check-certificate --allow-unplayable-formats --force-generic-extractor -R 25 --fragment-retries 25 --external-downloader aria2c --downloader-args "aria2c: -x 16 -j 32"'
